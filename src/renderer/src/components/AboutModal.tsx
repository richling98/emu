...
export const BEAUTY_FEATURES = [
  ...
  { title: 'Full-Width Title Bar', desc: 'Drag Emu from anywhere along the top edge — the entire title bar is a drag target, just like a native macOS app.' },
  ...
  { title: 'Smooth Animations', desc: 'Tab switches, sidebar collapse, drawer slide-ins, and pane transitions are all eased and timed so Emu never feels abrupt or janky.' },
    ...
    <div className="about-overlay" onClick={onClose}>
      <div className="about-modal" onClick={(e) => e.stopPropagation()}>
        <div className="about-header">
          <span className="about-title">Why Emu is better than your Terminal</span>
