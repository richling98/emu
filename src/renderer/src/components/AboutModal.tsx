...
const FEATURES = [
  ...
  { title: 'Screenshot & File Drop', desc: 'Drag any file — screenshot, image, document — straight from Finder into the terminal. Emmy instantly pastes the shell-escaped path, ready to use with Claude or any CLI tool.' },
  ...
  { title: 'Session Management', desc: 'Spin up as many named sessions as you need. Each gets its own PTY, timestamps, and history. Rename any session inline with a double-click.' },
  { title: 'Transparent Window', desc: 'Emmy\'s background is genuinely transparent — your desktop shows through, giving every session a grounded, contextual feel.' },
    ...
    <div className="about-overlay" onClick={onClose}>
      <div className="about-modal" onClick={(e) => e.stopPropagation()}>
        <div className="about-header">
          <span className="about-title">Emmy &gt; Terminal</span>
          <button className="about-close" onClick={onClose}>✕</button>
        </div>
        <div className="about-body">
          <p className="about-intro">
            Emmy is a terminal emulator designed to be 10x more beautiful and delightful than the stock terminal. Here's what makes it special:
          </p>
