...
const BEAUTY_FEATURES = [
  ...
  { title: 'Pick Your Theme', desc: 'Six hand-curated color themes — Catppuccin, Matrix, Francisco, Haze, Mocha, and Monokai. Click the color wheel in the top-right corner to switch instantly. Your choice is saved and restored every time you open Emmy.' },
