...
const FEATURE_FEATURES = [
  ...
  { title: 'Output Copy Button', desc: 'Every entry in the Command Log has a clipboard icon that copies the full output of that command to your clipboard in one click — clean text, no ANSI codes, no shell artifacts. Perfect for pasting errors straight into Claude Code.' },
