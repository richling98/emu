...
const FEATURE_FEATURES = [
  ...
  { title: 'Unlimited Tabs', desc: 'Spin up as many named sessions as you need. Each gets its own PTY, timestamps, and history. Rename any session inline with a double-click.' },
