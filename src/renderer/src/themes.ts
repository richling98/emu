...
export const THEMES: AppTheme[] = [
  ...
  },
  {
    ...
    name: 'Horizon',
    bgBase: '#1c1e26',
    bgPanel: 'rgba(20, 22, 30, 0.42)',
    bgTitlebar: 'rgba(22, 24, 33, 0.45)',
    accent: '#e95678',
    accentAlt: '#fab28e',
    terminal: {
      background: '#1c1e26',
      ...
      cursor: '#e95678',
      cursorAccent: '#1c1e26',
      selectionBackground: 'rgba(233, 86, 120, 0.2)',
      black: '#1c1e26',   brightBlack: '#4a4f5e',
      red: '#e95678',     brightRed: '#ec6a88',
      green: '#09f7a0',   brightGreen: '#09f7a0',
      yellow: '#fab28e',  brightYellow: '#fbc3a1',
      blue: '#21bfc2',    brightBlue: '#59e1e3',
      magenta: '#e95678', brightMagenta: '#ec6a88',
      cyan: '#59e1e3',    brightCyan: '#59e1e3',
      white: '#d5d8da',   brightWhite: '#ffffff',
    },
  },
  {
    id: 'synthwave',
